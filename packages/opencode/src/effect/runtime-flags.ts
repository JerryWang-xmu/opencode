...
export class Service extends ConfigService.Service<Service>()("@opencode/RuntimeFlags", {
  ...
  experimentalCoordinator: enabledByExperimental("OPENCODE_EXPERIMENTAL_COORDINATOR"),
  experimentalMemoryRetrieval: enabledByExperimental("OPENCODE_EXPERIMENTAL_MEMORY_RETRIEVAL"),
  experimentalAutoDream: Config.boolean("OPENCODE_EXPERIMENTAL_AUTO_DREAM").pipe(Config.withDefault(true)),
